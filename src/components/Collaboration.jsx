    ...
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="lg:ml-auto xl:w-152 mt-4">
          <p className="body-2 mb-8 text-n-4 md:mb-16 lg:mb-32 lg:w-88 lg:mx-auto">{collabText}</p>
          ...
          <div className="relative left-1/2 flex w-88 aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100">
            ...
            <ul>
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className="relative top-[-1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/30 rounded-xl"
                    style={{
                      transform: `rotate(-${index * 45}deg)`,
                    }}
                  >
